...
//         <MotionSubmitButton isSubmitting={isSubmitting} disabled={isSubmitting} className="w-3/4 rounded-lg text-center mx-auto cursor-pointer">
//           {isSubmitting
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <div className="space-y-1">
        <input
          ...
          placeholder={contact.form.placeholders.name}
          className="h-12 w-full rounded-xl border border-foreground/15 bg-background px-4 text-sm text-foreground placeholder:text-foreground/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/20"
          autoComplete="name"
        />
        {fieldErrors.name ? (
          <p className="text-xs text-foreground/70 pl-1">{fieldErrors.name}</p>
        ) : null}
      </div>
      ...
      <div className="space-y-1">
        ...
        />
        {fieldErrors.email ? (
          <p className="text-xs text-foreground/70 pl-1">{fieldErrors.email}</p>
        ) : null}
      </div>
      ...
      <div className="space-y-1">
        <textarea
          ...
          placeholder={contact.form.placeholders.details}
          rows={8}
          className="w-full resize-none rounded-xl border border-foreground/15 bg-background px-4 py-3 text-sm text-foreground placeholder:text-foreground/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/20"
        />
        {fieldErrors.details ? (
          <p className="text-xs text-foreground/70 pl-1">{fieldErrors.details}</p>
        ) : null}
      </div>
